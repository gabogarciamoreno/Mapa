...
var map = new ol.Map({
    ...
    view: new ol.View({
         maxZoom: 28, minZoom: 1, projection: new ol.proj.Projection({
            code: 'EPSG:3857',
            //extent: [-11877755.883823, 3702889.819198, -11836861.513784, 3735538.886082],
            units: 'm'})
    })
});

//initial view - epsg:3857 coordinates if not "Match project CRS"
map.getView().fit([-11877755.883823, 3702889.819198, -11836861.513784, 3735538.886082], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Ciclo rutas y BRT en Ciudad Juárez</h2>';
        return titleElement;
    })(),
